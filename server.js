...
function createTransaction(sellingUserWallet, buyerUserWallet, assetId) {
     ...
     */
    let details = {
        "to": buyerUserWallet, //process.env.DESTINATION_WALLET_ADDRESS,
        "value": web3.toHex(web3.toWei(amountToSend, 'ether')),
        "gas": 100000,
        "gasPrice": 0.5 * 1000000000, // converts the gwei price to wei
        "nonce": nonce,
        "data": assetId,
